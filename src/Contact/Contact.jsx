...
const Contact = () => {
    ...
    return (
        <div className="my-20" id="contacts">
            <h2 className="text-2xl font-serif mb-5 text-center font-semibold text-cyan-700">
                Contact Me
            </h2>
                                ...
                                <div>
                                    <span>
                                        <svg
                                            ...
                                            strokeWidth={1.5}
                                            stroke="currentColor"
                                            className="w-20 me-5 text-cyan-700"
                                        >
                                            <motion.path
                        ...
                        <div className="lg:flex gap-5">
                            <div className="form-control w-full">
                                ...
                                <input
                                    ...
                                    className="input input-bordered input-error text-cyan-700 w-full"
                                    required
                                />
                            </div>
                            <div className="form-control w-full">
